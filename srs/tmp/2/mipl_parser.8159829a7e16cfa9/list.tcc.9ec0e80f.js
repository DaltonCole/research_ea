...
{"lineNum":"   65","line":"    _List_base<_Tp, _Alloc>::","class":"lineCov","hits":"1","order":"1162","possible_hits":"1",},
{"lineNum":"   66","line":"    _M_clear() _GLIBCXX_NOEXCEPT"},
{"lineNum":"   67","line":"    {"},
{"lineNum":"   68","line":"      typedef _List_node<_Tp>  _Node;"},
{"lineNum":"   69","line":"      __detail::_List_node_base* __cur = _M_impl._M_node._M_next;","class":"lineCov","hits":"1","order":"1163","possible_hits":"1",},
{"lineNum":"   70","line":"      while (__cur != &_M_impl._M_node)","class":"lineCov","hits":"2","order":"1164","possible_hits":"2",},
{"lineNum":"   71","line":"\t{"},
{"lineNum":"   72","line":"\t  _Node* __tmp = static_cast<_Node*>(__cur);","class":"lineCov","hits":"1","order":"1165","possible_hits":"1",},
{"lineNum":"   73","line":"\t  __cur = __tmp->_M_next;","class":"lineCov","hits":"1","order":"1166","possible_hits":"1",},
{"lineNum":"   74","line":"\t  _Tp* __val = __tmp->_M_valptr();","class":"lineCov","hits":"1","order":"1167","possible_hits":"1",},
{"lineNum":"   75","line":"#if __cplusplus >= 201103L"},
{"lineNum":"   76","line":"\t  _Node_alloc_traits::destroy(_M_get_Node_allocator(), __val);","class":"lineCov","hits":"1","order":"1168","possible_hits":"1",},
{"lineNum":"   77","line":"#else"},
{"lineNum":"   78","line":"\t  _Tp_alloc_type(_M_get_Node_allocator()).destroy(__val);"},
{"lineNum":"   79","line":"#endif"},
{"lineNum":"   80","line":"\t  _M_put_node(__tmp);","class":"lineCov","hits":"1","order":"1172","possible_hits":"1",},
{"lineNum":"   81","line":"\t}"},
{"lineNum":"   82","line":"    }","class":"linePartCov","hits":"1","order":"1209","possible_hits":"2",},
{"lineNum":"   83","line":""},
