...
{"lineNum":"  267","line":"    operator==(const _Deque_iterator<_Tp, _Ref, _Ptr>& __x,","class":"lineCov","hits":"1","order":"1235","possible_hits":"1",},
{"lineNum":"  268","line":"\t       const _Deque_iterator<_Tp, _Ref, _Ptr>& __y) _GLIBCXX_NOEXCEPT"},
{"lineNum":"  269","line":"    { return __x._M_cur == __y._M_cur; }","class":"linePartCov","hits":"1","order":"1236","possible_hits":"2",},
{"lineNum":"  270","line":""},
...
{"lineNum":"  549","line":"      struct _Deque_impl","class":"linePartCov","hits":"2","order":"1643","possible_hits":"3",},
...
{"lineNum":"  587","line":"      _M_get_Tp_allocator() _GLIBCXX_NOEXCEPT","class":"lineCov","hits":"1","order":"1574","possible_hits":"1",},
{"lineNum":"  588","line":"      { return *static_cast<_Tp_alloc_type*>(&this->_M_impl); }","class":"linePartCov","hits":"1","order":"1575","possible_hits":"2",},
{"lineNum":"  589","line":""},
...
{"lineNum":"  606","line":"      _M_deallocate_node(_Ptr __p) _GLIBCXX_NOEXCEPT","class":"lineCov","hits":"1","order":"1604","possible_hits":"1",},
{"lineNum":"  607","line":"      {"},
{"lineNum":"  608","line":"\ttypedef __gnu_cxx::__alloc_traits<_Tp_alloc_type> _Traits;"},
{"lineNum":"  609","line":"\t_Traits::deallocate(_M_impl, __p, __deque_buf_size(sizeof(_Tp)));","class":"lineCov","hits":"1","order":"1605","possible_hits":"1",},
{"lineNum":"  610","line":"      }","class":"linePartCov","hits":"1","order":"1635","possible_hits":"2",},
{"lineNum":"  611","line":""},
...
{"lineNum":"  620","line":"      _M_deallocate_map(_Map_pointer __p, size_t __n) _GLIBCXX_NOEXCEPT","class":"lineCov","hits":"2","order":"1638","possible_hits":"2",},
{"lineNum":"  621","line":"      {"},
{"lineNum":"  622","line":"\t_Map_alloc_type __map_alloc = _M_get_map_allocator();","class":"lineCov","hits":"2","order":"1639","possible_hits":"2",},
{"lineNum":"  623","line":"\t_Map_alloc_traits::deallocate(__map_alloc, __p, __n);","class":"lineCov","hits":"1","order":"1640","possible_hits":"1",},
{"lineNum":"  624","line":"      }","class":"linePartCov","hits":"1","order":"1641","possible_hits":"2",},
{"lineNum":"  625","line":""},
...
{"lineNum":"  660","line":"    _Deque_base<_Tp, _Alloc>::","class":"lineCov","hits":"1","order":"1597","possible_hits":"1",},
{"lineNum":"  661","line":"    ~_Deque_base() _GLIBCXX_NOEXCEPT"},
{"lineNum":"  662","line":"    {"},
{"lineNum":"  663","line":"      if (this->_M_impl._M_map)","class":"lineCov","hits":"1","order":"1598","possible_hits":"1",},
{"lineNum":"  664","line":"\t{"},
{"lineNum":"  665","line":"\t  _M_destroy_nodes(this->_M_impl._M_start._M_node,","class":"lineCov","hits":"1","order":"1600","possible_hits":"1",},
{"lineNum":"  666","line":"\t\t\t   this->_M_impl._M_finish._M_node + 1);","class":"lineCov","hits":"1","order":"1599","possible_hits":"1",},
{"lineNum":"  667","line":"\t  _M_deallocate_map(this->_M_impl._M_map, this->_M_impl._M_map_size);","class":"lineCov","hits":"1","order":"1637","possible_hits":"1",},
{"lineNum":"  668","line":"\t}"},
{"lineNum":"  669","line":"    }","class":"linePartCov","hits":"1","order":"1642","possible_hits":"2",},
{"lineNum":"  670","line":""},
{"lineNum":"  671","line":"  /**"},
...
{"lineNum":"  738","line":"    _Deque_base<_Tp, _Alloc>::","class":"lineCov","hits":"1","order":"1601","possible_hits":"1",},
{"lineNum":"  739","line":"    _M_destroy_nodes(_Map_pointer __nstart,"},
{"lineNum":"  740","line":"\t\t     _Map_pointer __nfinish) _GLIBCXX_NOEXCEPT"},
{"lineNum":"  741","line":"    {"},
{"lineNum":"  742","line":"      for (_Map_pointer __n = __nstart; __n < __nfinish; ++__n)","class":"lineCov","hits":"2","order":"1602","possible_hits":"2",},
{"lineNum":"  743","line":"\t_M_deallocate_node(*__n);","class":"lineCov","hits":"1","order":"1603","possible_hits":"1",},
{"lineNum":"  744","line":"    }","class":"linePartCov","hits":"1","order":"1636","possible_hits":"2",},
{"lineNum":"  745","line":""},
{"lineNum":"  746","line":"  /**"},
...
{"lineNum":" 1043","line":"       */"},
{"lineNum":" 1044","line":"      ~deque()","class":"lineCov","hits":"2","order":"1572","possible_hits":"2",},
{"lineNum":" 1045","line":"      { _M_destroy_data(begin(), end(), _M_get_Tp_allocator()); }","class":"linePartCov","hits":"1","order":"1573","possible_hits":"2",},
{"lineNum":" 1046","line":""},
{"lineNum":" 1047","line":"      /**"},
...
{"lineNum":" 1166","line":"      begin() _GLIBCXX_NOEXCEPT","class":"lineCov","hits":"1","order":"1576","possible_hits":"1",},
{"lineNum":" 1167","line":"      { return this->_M_impl._M_start; }","class":"linePartCov","hits":"1","order":"1577","possible_hits":"2",},
{"lineNum":" 1168","line":""},
{"lineNum":" 1169","line":"      /**"},
...
{"lineNum":" 1357","line":"      empty() const _GLIBCXX_NOEXCEPT","class":"lineCov","hits":"1","order":"1233","possible_hits":"1",},
{"lineNum":" 1358","line":"      { return this->_M_impl._M_finish == this->_M_impl._M_start; }","class":"linePartCov","hits":"1","order":"1234","possible_hits":"2",},
{"lineNum":" 1359","line":""},
...
{"lineNum":" 1601","line":"      pop_back() _GLIBCXX_NOEXCEPT","class":"lineCov","hits":"1","order":"1525","possible_hits":"1",},
{"lineNum":" 1602","line":"      {"},
{"lineNum":" 1603","line":"\t__glibcxx_requires_nonempty();"},
{"lineNum":" 1604","line":"\tif (this->_M_impl._M_finish._M_cur","class":"lineCov","hits":"2","order":"1526","possible_hits":"2",},
{"lineNum":" 1605","line":"\t    != this->_M_impl._M_finish._M_first)","class":"lineCov","hits":"1","order":"1527","possible_hits":"1",},
{"lineNum":" 1606","line":"\t  {"},
{"lineNum":" 1607","line":"\t    --this->_M_impl._M_finish._M_cur;","class":"lineCov","hits":"1","order":"1528","possible_hits":"1",},
{"lineNum":" 1608","line":"\t    _Alloc_traits::destroy(this->_M_impl,","class":"lineCov","hits":"1","order":"1529","possible_hits":"1",},
...
{"lineNum":" 1613","line":"      }","class":"linePartCov","hits":"2","order":"1545","possible_hits":"3",},
{"lineNum":" 1614","line":""},
...
{"lineNum":" 2068","line":"      _M_destroy_data(iterator __first, iterator __last,","class":"lineCov","hits":"2","order":"1578","possible_hits":"2",},
{"lineNum":" 2069","line":"\t\t      const std::allocator<_Tp>&)"},
{"lineNum":" 2070","line":"      {"},
{"lineNum":" 2071","line":"\tif (!__has_trivial_destructor(value_type))"},
{"lineNum":" 2072","line":"\t  _M_destroy_data_aux(__first, __last);","class":"lineCov","hits":"1","order":"1579","possible_hits":"1",},
{"lineNum":" 2073","line":"      }","class":"linePartCov","hits":"1","order":"1596","possible_hits":"2",},
{"lineNum":" 2074","line":""},
